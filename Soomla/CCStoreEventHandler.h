...
namespace soomla {
    ...
    public:
        ...
        */
        virtual void onMarketPurchase(CCPurchasableVirtualItem *purchasableVirtualItem, cocos2d::CCString *token, cocos2d::CCString *payload, cocos2d::CCString *orderId) = 0;
        ...
        */
        ...
        /**
         ...
         @param purchasableVirtualItem The market item whose purchase is being 
                verified.
         */
        virtual void onMarketPurchaseVerification(CCPurchasableVirtualItem *purchasableVirtualItem, cocos2d::CCString *token, cocos2d::CCString *payload, cocos2d::CCString *orderId) = 0;
